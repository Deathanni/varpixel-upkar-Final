  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100">
                ...
                <div className="w-full h-96 bg-gradient-to-br from-cyan-400 via-blue-500 to-indigo-600 rounded-3xl transform rotate-3 shadow-2xl">
                  <div className="w-full h-full bg-white rounded-3xl transform -rotate-6 shadow-xl flex items-center justify-center">
                    <div className="text-center space-y-4">
                      <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 via-blue-500 to-indigo-500 rounded-2xl mx-auto flex items-center justify-center">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            <Badge className="bg-cyan-100 text-cyan-700">Testimonials</Badge>
            <h2 className="text-4xl font-bold text-gray-900">
